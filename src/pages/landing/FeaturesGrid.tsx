...
const FeaturesGrid: React.FC = () => <section className="py-20 bg-gray-50">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <h2 className="font-semibold text-gray-900 mb-4 text-4xl mx-0">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {FEATURES.map(f => <div key={f.title} className="p-4 text-center shadow-sm border border-gray-200 flex flex-col items-center py-[24px] rounded-lg bg-neutral-50">
